...
import io.github.plaza.designsys.resources.richtext_stardust_onetime
import io.github.plaza.designsys.resources.richtext_stardust_ref_id
    ...
    VoteCardSurface(modifier = modifier) {
        Row(
            ...
            Column(
                ...
                Text(
                    text = stringResource(Res.string.richtext_stardust_ref_id, node.refId),
                    style = MaterialTheme.typography.labelSmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                if (node.onetime) {
                    TonalTag(
                        text = stringResource(Res.string.richtext_stardust_onetime),
