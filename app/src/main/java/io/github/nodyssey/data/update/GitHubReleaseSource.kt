...
import io.github.nodyssey.core.update.versionNameOfTag
...
/**
 * GitHub Releases, which is where this project publishes.
 *
    ...
    override suspend fun latestRelease(): AppRelease? =
        withContext(dispatchers.io) {
            ...
            execute(request).use { response ->
                ...
                GitHubReleases.parseLatest(payload)
            }
        }
...
internal object GitHubReleases {
    ...
    fun parseLatest(payload: String): AppRelease? {
        val release =
            try {
        ...
        return AppRelease(
            ...
            htmlUrl = release.htmlUrl.ifBlank { GitHubReleaseSource.RELEASES_URL },
        )
    }
