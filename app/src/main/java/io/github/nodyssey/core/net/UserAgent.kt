...
/**
 * Asks the WebView what it is, rather than telling NodeSeek what we wish it were.
 *
 ...
 */
fun resolveUserAgent(context: Context): UserAgent {
    ...
    return if (default != null) {
        ...
        UserAgent(value = NodeSeekSite.FALLBACK_USER_AGENT, isWebViewDefault = false)
    }
}
