...
internal val NodeSeekLightColorScheme =
    lightColorScheme(
...
internal val NodeSeekDarkColorScheme =
    darkColorScheme(
        primary = DarkPrimary,
 ...
 */
@Immutable
data class NodeSeekExtraColors(
...
val LocalNodeSeekExtraColors = staticCompositionLocalOf { LightExtraColors }
