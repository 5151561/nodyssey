 ...
 */
private fun appLinkHandlingEnabled(context: Context): Boolean? {
 ...
 * end up.
 */
private fun appLinkSettingsIntent(context: Context): Intent {
    val target =
 ...
 */
@Composable
actual fun rememberAppLinkHandlingEnabled(): Boolean? {
